...
bool build_engine_from_onnx(const std::string& onnx_file,
                            const std::string& engine_file,
                            size_t workspace_size = 1ULL << 30);

std::shared_ptr<tdt_radar::Infer<BoxArray>>
load_or_build(const std::string& engine_file, const std::string& onnx_file,
              Type type, float confidence_threshold = 0.45f,
